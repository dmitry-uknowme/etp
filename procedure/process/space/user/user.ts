namespace $ {
  export enum $etp_procedure_process_space_user_role {
    ORGANIZER = "ORGANIZER",
    PARTICIPANT = "PARTICIPANT",
  }
  export class $etp_procedure_process_space_user extends $hyoo_crowd_struct {
    @$mol_mem
    name(next?: string) {
      return this.sub("name", $hyoo_crowd_reg).str(next);
    }

    role(next?: $etp_procedure_process_space_user_role) {
